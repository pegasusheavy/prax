...
pub mod fields {
    ...
    pub const ALL_SORTED: &[&str] = &[
        ACTIVE, AGE, AMOUNT, ARCHIVED, ATTEMPTS, AUTHOR_ID, AVATAR_URL, BODY, CATEGORY,
        COMPLETED_AT, CONTENT, COUNT, CREATED_AT, DATA, DELETED, DELETED_AT, DESCRIPTION,
        EMAIL, ENABLED, EXPIRES_AT, FILE, FIRST_NAME, FLAGGED, ID, IMAGE_URL, KIND,
        LAST_NAME, MAX_ATTEMPTS, METADATA, NAME, ORDER, ORG_ID, OWNER_ID, PARENT_ID,
        PASSWORD, PATH, POSITION, PRICE, PRIORITY, PUBLISHED, PUBLISHED_AT, QUANTITY,
        ROLE, SCORE, SLUG, STARTED_AT, STATUS, TAGS, TENANT_ID, TITLE, TYPE, UPDATED_AT,
        URL, USER_ID, UUID, VERIFIED, VERSION,
    ];
